			...
			<div className='max-w-[1150px] px-[15px] mx-auto flex py-20 md:flex-row flex-col items-center'>
				<div className='lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center'>
					...
					<p className='mb-5 leading-relaxed'>
						{' '}
						Celebrate milestones. Reward wins. Connect your people. And
						reimagine performance with the only recognition solution that
						motivates teams and empowers managers
					</p>
